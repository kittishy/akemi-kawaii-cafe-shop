...
export function SocialShare({ url, title, image }) {
  ...
  const shareLinks = [
    ...
    {
      name: 'WhatsApp',
      icon: <Link size={18} />, // Using Link from lucide as a replacement for WhatsApp
      url: `https://api.whatsapp.com/send?text=${encodedTitle} ${encodedUrl}`,
      color: 'bg-green-600 hover:bg-green-700'
    },
    {
      name: 'Pinterest',
      icon: <Instagram size={18} />, // Using Instagram from lucide as a replacement for Pinterest
